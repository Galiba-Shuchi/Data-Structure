...
int loginUser() {
    ...
    user u;
    int found = 0;
    while (fscanf(fp, "%19[^|]|%49[^|]|%49[^|]|%29[^\n]\n", u.student_id, u.name, u.password) == 4) {
...
void studentMenu() {
    ...
    while(1) {
        ...
        switch(choice) {
            ...
            case 6: {
                char course_code[20];
                printf("Enter course code to view PDFs: ");
                fgets(course_code, sizeof(course_code), stdin);
                course_code[strcspn(course_code, "\n")] = '\0';
            ...
            case 7: {
                char course_code[20];
                printf("Enter course code to view videos: ");
                fgets(course_code, sizeof(course_code), stdin);
                course_code[strcspn(course_code, "\n")] = '\0';
            ...
            case 8: {
                char course_code[20];
                printf("Enter course code to view web links: ");
                fgets(course_code, sizeof(course_code), stdin);
                course_code[strcspn(course_code, "\n")] = '\0';
                // Filter for web links only
                showMediaLinks(course_code);
                break;
            }
            case 9:
...
void teacherMenu() {
    ...
    while(1) {
        ...
        printf("4. Add Video\n");
        printf("5. Add PDF\n");
        printf("6. Add Web Link\n");
        printf("7. View Student Results\n");
        printf("8. Counseling Messages\n");
        printf("9. Update Counseling\n");
        printf("10. Delete Counseling\n");
        printf("11. Logout\n");
        printf("Enter your choice: ");
        scanf("%d", &choice);
        clearInputBuffer();
        ...
        switch(choice) {
            ...
            case 6: {
                ...
                fgets(m.title, sizeof(m.title), stdin);
                m.title[strcspn(m.title, "\n")] = '\0';
                strcpy(m.media_type, "web");
                printf("Enter web link URL: ");
                fgets(m.url, sizeof(m.url), stdin);
                m.url[strcspn(m.url, "\n")] = '\0';
                addMediaLink(&m);
                break;
